...
- DID Documents MUST use `publicKeyJwk` for their Verification Material (section 5.2.1).  Key MUST be secp256k1 or Ed25519, see the _Cryptographic Signature_ section.
